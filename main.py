...
def about_handler(update, context):
    ...
    update.message.reply_text('[🏖 TikTok Download API 🏖]\n\n[🔥 SL Developers </> 🇱🇰](https://t.me/Makkikoenak)',parse_mode=_ParseMode)
...
def Download_Video(Link,update, context):
    ...
    status_msg=message.reply_text('♻️ ᴍᴏʜᴏɴ ᴛᴜɴɢɢᴜ ʏᴀ ᴛᴏᴅᴅ  ....')
    ...
    try:
       ...
       print('Download Links Generated \n\n\n'+str(req)+'\n\n\n')
        ...
        status_msg.edit_text('⁉️ TikTok Downloader API Error !!! Report To Developer : @makkikoenak')
        status_sticker.delete()
        return
    
    caption_text="""◇───────────────◇

✅ BERHASIL TUH TODD {} Video 🔰

🔰 Powerd by : Faisal Wapi
[☢️ Bot Download Tiktok </> ](https://t.me/Makkikoenak) Corporation ©️
...
# https://t.me/Makkikoenak
# https://t.me/kataisall
